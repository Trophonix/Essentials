...
public class Commandbanip extends EssentialsCommand {
    ...
    public void run(final Server server, final CommandSource sender, final String commandLabel, final String[] args) throws Exception {
        ...
        server.getLogger().log(Level.INFO, tl("playerBanIpAddress", senderName, "REDACTED", banReason));

        ess.broadcastMessage("essentials.banip.notify", tl("playerBanIpAddress", senderName, "REDACTED", banReason));
    }
